...
export function LoadingSkeleton({
  ...
  const baseClasses =
    'bg-gradient-to-r from-bg-tertiary via-bg-secondary to-bg-tertiary rounded animate-pulse';
...
export function ProjectCardSkeleton() {
  return (
    <div className="bg-bg-tertiary/30 backdrop-blur-sm rounded-2xl overflow-hidden border border-dark-border/50 p-6 space-y-4">
...
export function SkillCardSkeleton() {
  return (
    <div className="bg-bg-tertiary/30 backdrop-blur-sm rounded-2xl border border-dark-border/50 p-6 space-y-4">
      <LoadingSkeleton variant="text" width="60%" height="20px" />
      <div className="grid grid-cols-2 gap-3">
        {[...Array(6)].map((_, i) => (
          <div key={i} className="flex items-center gap-2 p-2 rounded-lg bg-bg-primary/50">
