  ...
  return (
    ...
    >
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-4xl font-bold text-blue-600 dark:text-blue-400 mb-4">{t('about')}</h2>
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <div className="space-y-4 text-lg">
              <p className="text-blue-700 dark:text-blue-200">{t('aboutDescription1')}</p>

              <p className="text-blue-700 dark:text-blue-200">{t('aboutDescription2')}</p>

              <p className="text-blue-700 dark:text-blue-200">{t('aboutDescription3')}</p>
            </div>
            ...
            <div className="bg-blue-50 dark:bg-blue-900 p-6 rounded-xl">
              ...
              <ul className="space-y-2 text-blue-700 dark:text-blue-200">
                ...
                <li className="flex items-center gap-2">
                  <span className="w-2 h-2 bg-blue-500 rounded-full"></span>
                  {language === 'pt' ? 'Código limpo e manutenível' : 'Clean and maintainable code'}
                </li>
                <li className="flex items-center gap-2">
                  <span className="w-2 h-2 bg-blue-500 rounded-full"></span>
                  {language === 'pt'
          ...
          >
            {stats.map((stat, index) => (
              ...
              >
                ...
                <div className="text-sm text-blue-700 dark:text-blue-200">{stat.label}</div>
              </motion.div>
            ))}
          </motion.div>
        </div>
