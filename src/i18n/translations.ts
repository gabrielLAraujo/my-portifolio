...
export const translations: Record<"pt" | "en", Translations> = {
  pt: {
    ...
    heroTitle: "Full Stack Software Engineer apaixonado por criar soluções web modernas e eficientes",
  ...
  en: {
    ...
    heroTitle: "Full Stack Software Engineer passionate about creating modern and efficient web solutions",
    ...
    aboutDescription1: "I'm a Full Stack Software Engineer passionate about creating modern and efficient web solutions. With experience in web application development, I always strive to deliver high-quality products.",
